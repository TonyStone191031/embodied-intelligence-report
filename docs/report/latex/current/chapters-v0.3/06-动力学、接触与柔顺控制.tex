...
\end{lstlisting}
\sourceanchor{仓库 \path{frankarobotics/libfranka}；tag \texttt{0.15.0}；文件 \path{examples/cartesian_impedance_control.cpp}；许可证 Apache-2.0；符号 \path{impedance_control_callback}。}
