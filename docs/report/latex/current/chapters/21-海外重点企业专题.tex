...
\section*{98.2 跟踪 DeepMind 最该盯的不是“又发了模型”，而是接口是否继续下探}
...
\section*{99.2 NVIDIA 的真正赌注是把训练、仿真与部署做成同一条价值链}
...
\chapter*{100. Figure、Physical Intelligence、Tesla、Boston Dynamics}
...
\chapter*{101. Agility、Apptronik、1X、Sanctuary 等}
...
\section*{101.2 第二梯队最值得提供的是“可复制性证据”}
