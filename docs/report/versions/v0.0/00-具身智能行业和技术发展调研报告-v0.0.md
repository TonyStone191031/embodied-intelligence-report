...
本入口文件只负责维护报告总索引，不承载完整正文。正文严格按《[具身智能报告-V0.0-详细大纲](D:/Projects/embodied-intelligence-report/docs/planning/archive/v0.0/具身智能报告-V0.0-详细大纲.md)》对应的“部分”拆分维护，即：
...
- [详细大纲](D:/Projects/embodied-intelligence-report/docs/planning/archive/v0.0/具身智能报告-V0.0-详细大纲.md)
